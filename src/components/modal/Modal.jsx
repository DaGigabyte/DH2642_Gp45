...
function ModalContent({ title, children }) {
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] md:w-[70vw] lg:w-[60vw] xl:w-[40vw] translate-x-[-50%] translate-y-[-50%] bg-white border border-black rounded-md shadow-lg shadow-black/80 p-8 overflow-hidden focus:outline-none z-[1020]">
