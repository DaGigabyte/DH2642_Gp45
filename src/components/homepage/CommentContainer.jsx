...
export default function CommentContainer(props) {
  function verifyUserForComment() {
    if (props.isUserConfirmed) {
      return (
        <div className="w-full flex flex-col md:flex-row gap-1 md:gap-3 items-end md:items-end">
          <textarea
          ...
          />
          <button
            className="purpleButton text-xl font-medium min-w-[182px] h-full inline-block disabled:opacity-50 disabled:cursor-not-allowed  hover:disabled:border-gray-300"
      ...
      return (
        <>
          <textarea
            className="w-full border rounded p-2 content-start md:min-h-[6rem] disabled:opacity-50 disabled:cursor-not-allowed hover:disabled:bg-gray-200 hover:disabled:border-gray-300"
            defaultValue="Log in to enter text"
            disabled
          ></textarea>
          <button
            className="purpleButton text-xl font-medium text-center disabled:opacity-50 disabled:cursor-not-allowed  hover:disabled:border-gray-300"
            disabled
          >
  ...
  return (
    <div className="flex flex-col rounded-xl border-gray-300 md:p-2 bg-white">
      <div
        className={
          "relative flex flex-col gap-1 md:flex-row space-x-4 w-full text-black text-left rounded-xl border border-gray-300 md:p-3 bg-white items-end mb-5 shadow"
        }
      >
        {/* Image container */}
        ...
        <div className="absolute top-0 right-0 rounded-tr-xl rounded-bl-xl overflow-hidden">
          <div className="bg-pins-primary py-2 px-8 text-xl font-medium text-white">
            {" "}
            {props.post.source}
          </div>
        </div>
      ...
      <div
        className={
          "rounded-xl border border-gray-300 p-4 md:p-5 bg-white flex flex-col shadow"
        }
      >
